...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('luxclasses', '0003_rename_title_fitnessclasses_gym_class_name_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gym_class', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fitnessclasses', to='luxclasses.fitnessclasses')),
